...
Сохраняются ВСЕ посты за последние WINDOW_DAYS (35) дней: превью-страница
...
WINDOW_DAYS = 35     # сколько дней истории храним (хватает на самый длинный месяц + запас)
MSK = timezone(timedelta(hours=3))  # месяц на сайте считается по Москве
